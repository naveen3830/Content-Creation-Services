    ...
    return (
        <div className="bg-[#006747] text-white text-center p-12 rounded-2xl mt-10 shadow-xl">
            ...
            <div className="flex justify-center gap-5 mb-8 flex-col sm:flex-row">
                <a href="https://www.leadwalnut.com/contact-us" className="bg-white text-[#006747] py-4 px-8 rounded-lg text-lg font-bold cursor-pointer transition-all duration-300 ease-in-out hover:bg-gray-200 hover:-translate-y-1 hover:shadow-lg no-underline inline-block">🚀 Start Your Content Journey</a>
                <a href="https://www.leadwalnut.com/contact-us" className="bg-amber-500 border-2 border-amber-500 text-white py-4 px-8 rounded-lg text-lg font-bold cursor-pointer transition-all duration-300 ease-in-out hover:bg-amber-600 hover:border-amber-600 hover:-translate-y-1 hover:shadow-lg no-underline inline-block">📞 Schedule Strategy Call</a>
            </div>
